...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.pub_data'
        db.delete_column(u'blog_post', 'pub_data')

        # Adding field 'Post.pub_date'
        db.add_column(u'blog_post', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 13, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'blog_post', 'texto',
                      self.gf('django.db.models.fields.TextField')(default='texto'),
                      keep_default=False)

        # Adding field 'Post.pub_data'
        db.add_column(u'blog_post', 'pub_data',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 13, 0, 0)),
                      keep_default=False)
